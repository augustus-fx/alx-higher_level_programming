...
Project done during **Full Stack Software Engineering studies** at **ALXSEPROGRAM**. It aims to learn about how to connect to a MySQL database from a Python script, what ORM means and how to map a Python Class to a MySQL table.

## Technologies
* `MySQL 8.0.25` (version 8.0.25)
* `MySQLdb`, version (2, 0, 3, 'final', 0)
